...
> [!WARNING]
> [Azure IoT Operations](https://learn.microsoft.com/en-us/azure/iot-operations/) is currently in PREVIEW and subject to change. This repo is compatible with version v0.5.0, and is currently not maintained.
